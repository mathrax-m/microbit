...
- microbit-Ch07_2_値によって変化する関数.hex

#### 07-3. 値を返す関数

- microbit-Ch07_3_値を返す関数.hex
...
- microbit-Ch08_6_無線で受信しシリアル通信で書き出す（無線受信）.hex
- microbit-Ch08_6_無線で明るさと温度を送信する（無線送信）.hex
- Processing-Ch08-6-1 シリアル通信で受信した2つのデータをグラフにする

#### 08-7. タッチ操作のジュークボックス

- microbit-Ch08_7_タッチ操作のジュークボックス.hex

#### 08-8. 持ちやすいコントローラ

- microbit-Ch08_8_持ちやすいコントローラ（シリアル通信）.hex
- Processing-Ch08-8-1 シューティングゲーム風の画面
